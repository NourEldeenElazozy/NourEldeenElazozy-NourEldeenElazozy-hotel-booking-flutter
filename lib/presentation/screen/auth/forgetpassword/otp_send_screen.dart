  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: GetBuilder<PasswordController>(
        builder: (controller) {
          return PopScope(
            // canPop: false يعني أن هذا الـ PopScope يمنع العودة تلقائياً.
            // وهذا هو الجزء الذي يمنع العودة بزر السهم أو سحب الشاشة.
            canPop: false,
            // onPopInvoked هو الـ callback الجديد الذي يتم استدعاؤه
            // عندما يتم محاولة "pop" (العودة) لهذه الشاشة.
            onPopInvoked: (didPop) {
              // didPop ستكون true إذا تم السماح بالرجوع تلقائياً (بسبب canPop: true)
              // أو إذا لم يكن هناك PopScope آخر يمنع الرجوع.
              // في حالتنا، canPop: false، لذا didPop ستكون false هنا دائماً.
              // ومع ذلك، من الجيد التحقق للتأكد من أننا نغلق التطبيق فقط عندما يتم استدعاؤنا.
              if (!didPop) {
                SystemNavigator.pop(); // ✅ إغلاق التطبيق
              }
            },
            child: Scaffold(
              appBar: const CustomFullAppBar(title: MyString.choiceForgotPassword,automaticallyImplyLeading: false,),
